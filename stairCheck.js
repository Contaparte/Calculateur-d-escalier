...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calcTotalRiseContainerL = document.getElementById('calcTotalRiseContainerL');
    ...
    stairConfig.addEventListener('change', function() {
        ...
        if (this.value === 'l_shaped') {
            ...
            // Déclencher l'événement pour afficher les bons champs
            if (lShapedConfig) {
                lShapedConfig.dispatchEvent(new Event('change'));
            }
    ...
    if (calcLShapedConfig) {
        calcLShapedConfig.addEventListener('change', function() {
            ...
            calcTotalRiseContainerL.style.display = 'none';
            
            if (this.value === 'standard_landing') {
                calcLandingDimensions.style.display = 'block';
                calcStandardRunContainer.style.display = 'none';
                calcTotalRiseContainerL.style.display = 'block';
            }
        });
    }
