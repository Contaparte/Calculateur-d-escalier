...
function generateDancingStepsVisualization(stairData) {
 ...
 if (isUConfig) {
  ...
  svg += '<line x1="' + r(v1X) + '" y1="' + arrowY + '" x2="' + r(turnCenterX) + '" y2="' + arrowY + '" stroke="#1b5e20" stroke-width="1.5"/>';
  ...
  svg += '<line x1="' + r(turnCenterX) + '" y1="' + arrowY + '" x2="' + r(arrowMidV2X) + '" y2="' + r(arrowMidV2Y) + '" stroke="#1b5e20" stroke-width="1.5"/>';
  ...
  // Cotations
  // Longueur partie 1 (en haut)
  const dimY1 = r(v1Y - 15);
  svg += '<line x1="' + v1X + '" y1="' + dimY1 + '" x2="' + r(v1X + rect1_plan) + '" y2="' + dimY1 + '" stroke="#555" stroke-width="1" marker-start="url(#arrDS)" marker-end="url(#arrDE)"/>';
  ...
  // Cotation longueur volée 2 (le long de la volée inclinée)
  const dimOffset = 20;
