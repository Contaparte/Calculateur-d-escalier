...
function calculateUShapedStair(params) {
 ...
 switch (uShapedConfig) {
  ...
  // Longueur 1ère partie = girons rectangulaires section 1
  // Longueur 2ème partie = girons rectangulaires section 2
  // Les rayonnantes et le palier sont dans les zones de virage (pas dans la longueur rectangulaire)
  numLandings = 1;
  availableForTreads = flight1Run + flight2Run;
  break;
  default:
