...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calcLandingRiseContainer = document.getElementById('calcLandingRiseContainer');
    ...
    calcMeasurementSystem.addEventListener('change', function() {
        ...
        if (lastCalculatorParams && lastCalculatorParams.solutions) {
            // Reformater sans recalculer
            lastCalculatorParams.isMetric = calcMeasurementSystem.value === 'metric';
    ...
    if (calcLShapedConfig) {
        calcLShapedConfig.addEventListener('change', function() {
            if (this.value === 'standard_landing') {
                ...
                calcLandingRiseContainer.style.display = 'block';
            } else {
                calcStandardRunContainer.style.display = 'block';
                calcLandingDimensions.style.display = 'none';
                calcLandingRiseContainer.style.display = 'none';
            }
        });
    }
    ...
    function performCalculation() {
        ...
        lastCalculatorParams = {
            ...
            lShapedConfigValue,
            isMetric,
            solutions  // Stocker pour reformatage
        };
