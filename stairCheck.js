...
function generateUShapedStairVisualization(stairData) {
 ...
 if (flight1Treads > 0) {
  for (let i = 1; i <= flight1Treads; i++) {
  // Position Y: du bas vers le haut, chaque giron a la MÅ ME profondeur que dans volée 2
 ...
 if (flight2Treads > 0) {
  ...
  // Annotation nombre de girons rectangulaires volée 2 - MÅ ME DIRECTION que volée 1 (rotation -90)
...
function generateUShapedRadiatingVisualization(stairData) {
 ...
 // Donc TOUS les girons rectangulaires ont la MÅ ME profondeur (treadDepth calculé globalement)
