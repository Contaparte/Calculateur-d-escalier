...
// Fonction pour dessiner un escalier en U
...
// Fonction pour dessiner un escalier à marches dansantes
...
// Fonction pour dessiner un escalier hélicoïdal
    ...
    if (checkButton) {
        checkButton.addEventListener('click', function() {
            ...
            if (isCompliant) {
                ...
                // Générer la visualisation après l'ajout au DOM
                setTimeout(() => {
