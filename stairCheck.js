...
function calculateUShapedStair(params) {
    ...
    const hasRadiating = uShapedConfig === 'radiating' || uShapedConfig === 'rect_radiating_rect' ||
                         uShapedConfig === 'rect_landing_radiating_rect' || uShapedConfig === 'rect_radiating_landing_rect' ||
