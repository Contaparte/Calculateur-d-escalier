...
function displayCalculatorResults(solutions, params) {
    ...
    if (isMetric) {
        ...
        html += `${best.numRisers} Ã— ${riserIn.toFixed(6)}" = ${totalRiseIn.toFixed(6)}" ✓`;
    }
    ...
    html += `<li>${best.stepRule.rule2.isValid ? '✓' : '✗'} G Ã— H = ${best.stepRule.rule2.value.toFixed(2)} (${best.stepRule.rule2.range})</li>`;
...
function displayVerificationResults(params) {
    ...
    html += `<li>${stepRule.rule2.isValid ? '✓' : '✗'} Règle 2 (GÃ—H) : ${stepRule.rule2.value.toFixed(2)} poÂ² (71-74)</li>`;
