...
function generateStraightStairVisualization(stairData) {
    ...
    // Note E.H.
    svg += '<text x="' + (legendX + cellW * cols + 10) + '" y="' + (legendY + cellH + 5) + '" style="font:8px Arial;fill:#666;">E.H. = En haut</text>';
...
function generateUShapedStairVisualization(stairData) {
    ...
    // Lignes des girons volée 1 (horizontales) - tracées avec profondeur UNIFORME
    // IMPORTANT: Diviser la hauteur totale par le nombre de girons pour une répartition exacte
    // IMPORTANT: Utiliser une épaisseur uniforme de 1.5 pour toutes les lignes de contremarche
    if (flight1Treads > 0) {
        const flight1TreadDepth = flight1Run_plan / flight1Treads; // Profondeur exacte pour cette volée
        for (let i = 1; i <= flight1Treads; i++) {
            // Position Y: du bas vers le haut, chaque giron a la même profondeur
            const lineY = r(flight1Y + flight1Run_plan - (i * flight1TreadDepth));
        ...
        // Marche 1: en bas
        const tread1CenterY = r(flight1Y + flight1Run_plan - flight1TreadDepth/2);
        ...
        const treadLastV1CenterY = r(flight1Y + flight1TreadDepth/2);
        ...
        // Annotation nombre de girons rectangulaires volée 1 (sur le côté)
        svg += '<text x="' + r(flight1X - 8) + '" y="' + r(flight1Y + flight1Run_plan/2) + '" style="font:9px Arial;fill:#666;" text-anchor="middle" transform="rotate(-90 ' + r(flight1X - 8) + ' ' + r(flight1Y + flight1Run_plan/2) + ')">' + flight1Treads + ' girons rect.</text>';
    }
    ...
    // Lignes des girons volée 2 (horizontales) - épaisseur uniforme de 1.5
    // IMPORTANT: Diviser la hauteur totale par le nombre de girons pour une répartition exacte
    if (flight2Treads > 0) {
        const flight2TreadDepth = flight2Run_plan / flight2Treads; // Profondeur exacte pour cette volée
        for (let i = 1; i <= flight2Treads; i++) {
            // Position Y: depuis le haut
            const lineY = r(flight2Y + ((i - 1) * flight2TreadDepth));
        ...
        const treadFirstV2CenterY = r(flight2Y + flight2TreadDepth/2);
        ...
        const treadLastV2CenterY = r(flight2Y + flight2Run_plan - flight2TreadDepth/2);
        ...
        // Annotation nombre de girons rectangulaires volée 2
        svg += '<text x="' + r(flight2X + stairWidth_plan + 8) + '" y="' + r(flight2Y + flight2Run_plan/2) + '" style="font:9px Arial;fill:#666;" text-anchor="middle" transform="rotate(90 ' + r(flight2X + stairWidth_plan + 8) + ' ' + r(flight2Y + flight2Run_plan/2) + ')">' + flight2Treads + ' girons rect.</text>';
    }
    ...
    // E.H. en bas à gauche de la volée 1 (entrée) - positionné à l'extérieur pour éviter conflit
    svg += '<text x="' + r(flight1X - 5) + '" y="' + r(arrowY1Start + 12) + '" style="font:bold 9px Arial;fill:#1b5e20;">E.H.</text>';
