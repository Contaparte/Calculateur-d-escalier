...
function generateStraightStairVisualization(stairData) {
 ...
 const scalePlan = Math.min(planW / totalRun, planH / actualWidth) * 0.80;
...
function generateLShapedStairVisualization(stairData) {
 ...
 const scalePlan = Math.min(planW / totalPlanW, planH / totalPlanH) * 0.80;
...
function generateUShapedStairVisualization(stairData) {
 ...
 const scalePlan = Math.min(planW / totalPlanWidth, planH / maxFlightRun) * 0.80;
...
function generateUShapedRadiatingVisualization(stairData) {
 ...
 const scalePlan = Math.min(planW / totalPlanWidth, planH / totalPlanHeight) * 0.80;
