 ...
 * doivent être testés APRàË†S les formats avec apostrophe obligatoire
 */
/**
 * Convertit une valeur impériale en millimètres
...
function generateUShapedStairVisualization(stairData) {
 ...
 if (flight1Treads > 0) {
  for (let i = 1; i <= flight1Treads; i++) {
  // Position Y: du bas vers le haut, chaque giron a la MàÅ ME profondeur que dans volée 2
 ...
 if (flight2Treads > 0) {
  ...
  // Annotation nombre de girons rectangulaires volée 2 - MàÅ ME DIRECTION que volée 1 (rotation -90)
...
function generateUShapedRadiatingVisualization(stairData) {
 ...
 // Donc TOUS les girons rectangulaires ont la MàÅ ME profondeur (treadDepth calculé globalement)
...
document.addEventListener('DOMContentLoaded', function() {
 ...
 function performCalculation() {
  ...
  contentDiv.innerHTML = '<h3>✗ Configuration non permise</h3>' +
   '<div class="warning"><p>Les escaliers hélicoà¯daux ne sont pas permis pour les bâtiments de Partie 3 (CNB 9.8.4.7.(3)).</p>' +
   '<p><strong>Solutions :</strong></p><ul>' +
   '<li>Utilisez un escalier droit ou avec palier</li>' +
   '<li>Les hélicoà¯daux sont réservés aux logements de Partie 9</li></ul></div>';
  resultDiv.className = 'result non-compliant';
  resultDiv.style.display = 'block';
  return;
  }
 ...
 function performVerification() {
  ...
  // Vérifications spécifiques pour escaliers hélicoà¯daux (CNB 9.8.4.7)
 ...
 function validateSpiralInputs() {
  ...
  // Note: Pour l'instant, les champs hélicoà¯daux ne sont pas encore présents dans le calculateur
