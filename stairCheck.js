...
function displayCalculatorResults(solutions, params) {
    ...
    if (!solutions || solutions.length === 0) {
        ...
        if (flightHeightExceeded && stairConfigValue !== 'l_shaped' && stairConfigValue !== 'u_shaped') {
            if (isMetric) {
    ...
    const isTreadOk = best.treadDepth >= limits.minTread && best.treadDepth <= limits.maxTread;
    ...
    // Visualisation graphique pour volée droite uniquement (seulement si conforme)
