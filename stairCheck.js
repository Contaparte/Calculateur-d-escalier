...
const CNB_LIMITS = {
 ...
 // =====================================================================
 // ESCALIERS HÉLICOà ÂDAUX (CNB 2020, Article 9.8.4.7)
 // =====================================================================
 spiral: {
 ...
 * - àâ€šÂ¬ l'intersection des deux volées (cas standard)
 * - àâ€šÂ¬ l'extrémité de la volée (quand firstFlightRun ou secondFlightRun = stairWidth)
 */
 ...
 * Conforme au CNB 9.8.4.6: chaque série de marches rayonnantes ââ€°Â¤ 90°
 */
function generateUShapedMixedVisualization(stairData) {
 ...
 if (configType === 'rect_landing_radiating_rect') {
  ...
  // Segment 2: Traverse horizontalement le coin et le palier (virage à 90°)
...
document.addEventListener('DOMContentLoaded', function() {
 ...
 function performCalculation() {
  ...
  contentDiv.innerHTML = '<h3>✗ Configuration non permise</h3>' +
   '<div class="warning"><p>Les escaliers hélicoàÂ¯daux ne sont pas permis pour les bâtiments de Partie 3 (CNB 9.8.4.7.(3)).</p>' +
   '<p><strong>Solutions :</strong></p><ul>' +
   '<li>Utilisez un escalier droit ou avec palier</li>' +
   '<li>Les hélicoàÂ¯daux sont réservés aux logements de Partie 9</li></ul></div>';
  resultDiv.className = 'result non-compliant';
  resultDiv.style.display = 'block';
  return;
  }
 ...
 function performVerification() {
  ...
  // Vérifications spécifiques pour escaliers hélicoàÂ¯daux (CNB 9.8.4.7)
 ...
 function validateSpiralInputs() {
  ...
  // Note: Pour l'instant, les champs hélicoàÂ¯daux ne sont pas encore présents dans le calculateur
