...
function generateLShapedStairVisualization(stairData) {
    ...
    if (isLanding) {
        ...
        // Fleche de montee continue - part de la 1ere CM, traverse le palier, finit a la derniere CM
        ...
        if (isRadiatingAtExtremity && radiatingAtEnd) {
            ...
            // Fleche de montee continue - part de la 1ere CM, tourne a 90 degres
            const arrow1Y = r(planStartY + stairWidth_plan/2);
            const arrowStartX = r(planStartX + treadW1_exact);  // Depart a la 1ere CM
...
function displayCalculatorResults(solutions, params) {
    ...
    if (!solutions || solutions.length === 0) {
        ...
        let html = '<h3>✗ Aucune solution trouvée</h3>';
    ...
    // Titre simplifié
    html += `<h3>${isCompliant ? '✓' : '✗'} Solution optimale</h3>`;
