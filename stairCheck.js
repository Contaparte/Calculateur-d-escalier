...
const CNB_LIMITS = {
 ...
 // =====================================================================
 // ESCALIERS HÉLICOàÂDAUX (CNB 2020, Article 9.8.4.7)
 // =====================================================================
 spiral: {
...
function generateLShapedStairVisualization(stairData) {
 ...
 if (isLanding) {
  ...
  svg += '<text x="' + r(palierX + landingW_plan * 0.22) + '" y="' + r(palierY + landingW_plan * 0.28 + 4) + '" style="font:bold 9px Arial;fill:#f57f17;" text-anchor="middle">' + (flight1Treads + 1) + '</text>';
  // Mot "Palier" décalé vers le bas-droite pour éviter conflit avec la flèche
  svg += '<text x="' + r(palierX + landingW_plan * 0.65) + '" y="' + r(palierY + landingW_plan * 0.82 + 4) + '" style="font:italic 10px Arial;fill:#f57f17;" text-anchor="middle">Palier</text>';
